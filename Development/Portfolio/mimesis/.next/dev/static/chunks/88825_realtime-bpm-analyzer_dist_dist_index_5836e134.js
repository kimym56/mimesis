...
"[project]/Development/Portfolio/mimesis/node_modules/realtime-bpm-analyzer/dist/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
__export(index_exports, {
    ...
    analyzeFullBuffer: ()=>analyzeFullBuffer,
    createRealTimeBpmProcessor: ()=>createRealTimeBpmProcessor,
    createRealtimeBpmAnalyzer: ()=>createRealtimeBpmAnalyzer,
    getBiquadFilter: ()=>getBiquadFilter
});
...
// src/core/analyzer.ts
function findPeaksAtThreshold({ audioSampleRate, data, threshold, offset = 0 }) {
    if (threshold < 0 || threshold > 1) {
        throw new Error("Invalid threshold: " + threshold + ". Threshold must be between 0 and 1.");
    }
    if (audioSampleRate <= 0) {
...
var RealTimeBpmAnalyzer = class {
   ...
   * @param options.currentMaxIndex - Current maximum index
   * @param options.postMessage - Function to post a message to the processor node
   */ async findPeaks({ audioSampleRate, channelData, bufferSize, currentMinIndex, currentMaxIndex, postMessage }) {
        await descendingOverThresholds(async (threshold)=>{
            if (this.nextIndexPeaks[threshold] >= currentMaxIndex) {
                return false;
            }
...
//# sourceMappingURL=88825_realtime-bpm-analyzer_dist_dist_index_5836e134.js.map