...
export const WIPER_STAGE_DASHBOARD_COLOR = "#12161b";
export const WIPER_STAGE_TRIM_COLOR = "#262d34";
export const WIPER_STAGE_GLASS_COLOR = "#d7dde2";
export const WIPER_STAGE_GLASS_OPACITY = 0.11;
export const WIPER_STAGE_EXTERIOR_COLOR = "#e4e7e9";
export const WIPER_STAGE_HEADLINER_COLOR = "#14181d";
export const WIPER_STAGE_COWL_COLOR = "#101418";
export const WIPER_STAGE_SCREEN_FRAME_COLOR = "#11161a";
export const WIPER_STAGE_SCREEN_SURFACE_COLOR = "#171c20";
export const WIPER_STAGE_SCREEN_GLOW_COLOR = "#d9e3eb";
export const WIPER_STAGE_DISPLAY_MOUNT_COLOR = "#2b3239";
export const WIPER_STAGE_WINDSHIELD_FRAME_COLOR = "#20262c";
export const WIPER_STAGE_SIMULATOR_GROUND_COLOR = "#f1f3f4";
export const WIPER_STAGE_SIMULATOR_GRID_COLOR = "#c8cfd5";
export const WIPER_STAGE_YOKE_COLOR = "#1a2026";
export const WIPER_STAGE_WIPER_ARM_COLOR = "#171c21";
export const WIPER_STAGE_WIPER_BLADE_COLOR = "#0d1013";
