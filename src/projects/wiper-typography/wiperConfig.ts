...
export const WIPER_STAGE_HEADLINER_COLOR = "#12181f";
export const WIPER_STAGE_COWL_COLOR = "#0d1218";
export const WIPER_STAGE_SCREEN_FRAME_COLOR = "#0f1318";
export const WIPER_STAGE_SCREEN_SURFACE_COLOR = "#09121b";
export const WIPER_STAGE_SCREEN_GLOW_COLOR = "#8cc7ff";
export const WIPER_STAGE_YOKE_COLOR = "#181d23";
